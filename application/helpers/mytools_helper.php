...
function recursive_remove_directory($directory, $empty=FALSE)
{
  ...
  */
        ...
        foreach($languages as $key=>$language)
        {
            ...
            if(!$key == 0)
            {
                ...
                else
                {
                    ...
                    if ($module =='menus' OR $module =='lilly_fairies_menus')
                    {
                        ...
                        echo anchor("$module/admin/langcreate/".$itemid. "/". $item['page_uri_id']."/".$key, "<img src=\"".base_url()."assets/icons/add.png\"  alt=\"add\" />\n".$language);
                    ...
                    elseif($module == 'pages' OR $module =='lilly_fairies_pages')
                    {
                        echo anchor("$module/admin/langcreate/".$item['id']."/".$item['path']."/".$key, '<img src="'.base_url().'assets/icons/add.png"  alt="add" />'.$language);
                        //echo anchor('pages/admin/langcreate/'.$pagecontent['id']."/".$key."/".$pagecontent['path'], $language);
                    }elseif($module == 'category' || $module == 'playroom' )
                    {
                        echo anchor($module."/admin/langcreate/".$item['id']."/".$key,"<img src=\"".base_url()."assets/icons/add.png\"  alt=\"add\" />\n". $language);
                    }/*
                    elseif($module == 'products')// for cecilieokada.com
                    {
                        echo anchor($module."/manage/langcreate/".$item['id']."/".$key."/".$item['category_id'],"<img src=\"".base_url()."assets/icons/add.png\"  alt=\"add\" />\n". $language);
                    }*/
                    elseif($module == 'manage')// for cecilieokada.com
                    {
                        echo anchor("products/".$module."/langcreate/".$item['id']."/".$key."/".$item['category_id'],'<img src="'.base_url().'assets/icons/add.png"  alt="add" />'. $language);
                    }
                    else
                    {
                        // lillyfairies menu or pages
    ...
    /**
     * This takes string from db which is from TINYmce, such as 
     * '<p><img src="../../../../assets/images/frontpage/image1.gif" 
     *   alt="" width="790" height="356" /></p>';
     * And it returns image1.gif
     * @param type $subject
     * @return string 
     */
    
    function getImageName($subject)
    {
     ...
     * '<p><img src="../../../../assets/images/frontpage/image1.gif" 
     *   alt="" width="790" height="356" /></p>';
     * And it returns assets/images/frontpage/image1.gif 
     * @param type $subject
     * @return type 
     */    
