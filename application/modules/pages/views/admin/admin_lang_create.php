...
echo "<tr><td class='label'><label for='metakeyword'>".$this->lang->line('kago_meta_keyword')."</label><br />\n";
echo $this->lang->line('kago_original').$pagecontent['metakeyword']."</td>";
$data = array('name'=>'metakeyword','id'=>'metakeyword','class'=>'text');
echo "<td>";
echo form_input($data);
echo "</td></tr>\n";

echo "<tr><td class='label'><label for='metadesc'>".$this->lang->line('kago_meta_desc')."</label><br />\n";
echo $this->lang->line('kago_original').$pagecontent['metadesc']."</td>";
$data = array('name'=>'metadesc','id'=>'desc','class'=>'text');
echo "<td>";
echo form_input($data);
echo "</td></tr>\n";
