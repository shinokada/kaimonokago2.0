...
$data = array('name'=>'metadesc','id'=>'metadesc','class'=>'text', 'value' => $category['metadesc']);
echo "<td>";
echo form_input($data);
echo "</td></tr>\n";

echo "<tr><td class='label'><label for='metakeyword'>".$this->lang->line('kago_meta_keyword')."</label></td>\n";
$data = array('name'=>'metakeyword','id'=>'metakeyword','class'=>'text', 'value' => $category['metakeyword']);
echo "<td>";
echo form_input($data);
echo "</td></tr>\n";
