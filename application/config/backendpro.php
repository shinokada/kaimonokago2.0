...
//$config['simplepie_cache_dir'] = base_url(). 'cache/';
$config['simplepie_cache_dir'] = BASEPATH . 'cache/';// this works only under system directory
//it doesn't work in assests or other directory
